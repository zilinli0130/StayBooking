...
// * Author: zilin.li
// * Date: 04/23
// * Definition: Implementation of ReservationService class.
//**********************************************************************************************************************
...
// Project includes
import com.zilinli.staybooking.exception.ReservationCollisionException;
import com.zilinli.staybooking.exception.ReservationNotFoundException;
...
//**********************************************************************************************************************
    ...
    public void add(Reservation reservation) throws ReservationCollisionException {
        ...
        // Check reservation collision from stay reservation date repository
        ...
        // Generate new stay reservation data based on current stay, check-in and check-out date
        ...
        // TODO: update the list of stay reserved date in stay instance
    }
